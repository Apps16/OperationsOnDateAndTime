...
public class ConverterFromAnyTimeFormatToAnyOtherTimeFormat {
	public static void main(String[] args) {
		...
		ConverterFromAnyTimeFormatToAnyOtherTimeFormat dateConverter = new ConverterFromAnyTimeFormatToAnyOtherTimeFormat();
		try {

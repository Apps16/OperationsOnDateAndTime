...
public class ConverterFromAnyDateFormatToAnyOtherDateFormat {
	public static void main(String[] args) {
		...
		ConverterFromAnyDateFormatToAnyOtherDateFormat dateConverter = new ConverterFromAnyDateFormatToAnyOtherDateFormat();
		try {
